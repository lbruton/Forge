...
- [ ] 2. Storage service + Zustand store
...
- [ ] 4. Substitution engine + syntax highlighter
...
- [ ] 5. Vault engine (.stvault encryption)
...
- [ ] 6. App shell + sidebar navigation (ui:true)
...
- [ ] 7. Template editor + paste flow (ui:true)
...
- [ ] 8. Config generator + preview (ui:true)
...
- [ ] 10. Vault import/export UI (ui:true)
...
- [ ] 11. Welcome screen + seed template
...
- [ ] 12. Docker container + deployment config
