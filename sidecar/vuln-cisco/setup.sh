...
echo ""
echo "  FORGE_CORS_ORIGIN  The Forge frontend URL (your reverse proxy address)."
echo "                     Default: http://localhost:5173 (Vite dev server)"
echo "  FORGE_VULN_PORT    Sidecar listen port. Default: 8400"
echo "  DATA_DIR           Scan results directory. Default: /data/results"
echo ""
...
echo "  4. Endpoint: your sidecar URL (e.g. https://<your-host>/forge or http://localhost:8400)"
